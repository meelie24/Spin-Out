...
export default function ResearchPage() {
  return <main className="plain-page research-page">
    <p className="kicker">Research</p><h1>Why Spin Out works this way</h1>
    <p className="lead">The game is simple. The decisions around it aren’t. The design borrows from research on chasing losses, random-outcome beliefs, gambling cues, interruptions and messages shown during play.</p>
    <section><h2>Chasing losses</h2><p>Losing can make leaving harder because another bet can feel like a way to erase what just happened. Reality Pings surface the specific thing being chased instead of hiding the loss behind game language.</p><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC2827449/" target="_blank" rel="noreferrer">Background on gambling decision-making</a></section>
